...
-(void)collectionCellManageData:(NSString*)cityString{
    if ([cityString isEqualToString:@"Add New"]) {
        ...
        _cityCodeLabel.textColor = [UIColor colorWithRed:(123.0f/255.0f) green:(174.0f/255.0f) blue:(55.0f/255.0f) alpha:1.0];
        _cityCodeLabel.layer.borderColor = [UIColor colorWithRed:(123.0f/255.0f) green:(174.0f/255.0f) blue:(55.0f/255.0f) alpha:1.0].CGColor;
