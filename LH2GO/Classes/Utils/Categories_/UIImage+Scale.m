...
- (UIImage *)squareImage {
    ...
    CGSize sz = self.size;
    float stL = (sz.height > sz.width) ? sz.width : sz.height;
    sz.height = sz.width = stL;
    
    CGImageRef imageRef = CGImageCreateWithImageInRect([self CGImage], CGRectMake(0, 0, stL, stL));
